...
export function LayoutHeader({ headerDark = false }) {
  ...
  return (
    <Header height={80} sx={headerDark ? { backgroundColor: "#00093C" } : undefined}>
      <Container className={classes.inner}>
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <Language size={35} color={headerDark ? "white" : "#000000"} />
          <Text color={headerDark ? "#FFFFFF" : undefined} weight={600} size={26} ml={10}>
            ForeignApp
          </Text>
        </Box>
        ...
        <Group spacing={0} className={classes.social} position="right" noWrap>
          ...
          <Group className={classes.links} spacing={5}>
            ...
            >
              ...
              <Text color={headerDark ? "white" : undefined} className={classes.link}>
                Главная
              </Text>
            </Box>
